...
public record MarginIconData
{
    ...
    /// <param name="widthCalculator">
    ///     Function that takes a scale factor and returns the required width at that scale. If null,
    ///     uses default 16 * scale.
    /// </param>
    ...
    {
        return _widthCalculator?.Invoke(scale) ?? 16 * scale;
    }
}
...
/// <param name="scale">
///     The scale that should be used for drawing, according to the editor's font size. This will be 1 if
///     the font size is 12.
/// </param>
