...
public interface IAddons
{
    ...
    AddonState GetAddonState(IAddon addon);
    ...
    IAddon? GetAddon(string addonIdentifier);
    ...
    IEnumerable<IAddon> GetAddons(AddonState state = AddonState.Installed);
    ...
    SkEditorSelfAddon GetSelfAddon();
}